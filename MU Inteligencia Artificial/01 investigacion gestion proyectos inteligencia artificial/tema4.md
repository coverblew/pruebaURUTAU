...
Publicación de resultados y redacción científica

Investigación y Gestión de Proyectos en Inteligencia Artificial

Índice

[Esquema 3](#_Toc153887743)

[Ideas clave 4](#_Toc153887744)

[4.1. Introducción y objetivos 4](#_Toc153887745)

[4.2. El ciclo de las publicaciones científicas 4](#_Toc153887746)

[4.3. Congresos, revistas, libros y ponencias 10](#_Toc153887747)

[4.4. El estilo de redacción científica 13](#_Toc153887748)

[4.5. Citas y formatos de bibliografía 17](#_Toc153887749)

[4.6. Referencias bibliográficas 23](#_Toc153887750)

[A fondo 24](#_Toc153887751)

[Test 25](#_Toc153887752)
...
Figura 1. Detalle de una publicación. Fuente: <https://www.journals.elsevier.com/artificial-intelligence/>

Existen **dos versiones** del índice JCR:

* JCR Science Edition: para publicaciones del ámbito científico y tecnológico.
* JCR Social Sciences Edition: para publicaciones relacionadas con las ciencias sociales.
...
1. **PASO 1.** Comprobar que la revista seleccionada se ajusta a nuestros intereses verificando impacto y ámbito de influencia.
2. **PASO 2.** Analizar detenidamente las instrucciones para los autores que suelen estar disponible en la página web y que hacen referencia a las normas de estilo, colores permitidos, formato de imágenes, extensión, etc.
3. **PASO 3.** Elegir de forma cuidadosa el título de la publicación buscando la máxima claridad e impacto. El resumen y las conclusiones son también parte destacada de la publicación.
4. **PASO 4.** Enviar la publicación.
5. **PASO 5.** El editor devuelve el manuscrito informando del rechazo, aceptación o solicitud de revisión de la publicación. Es habitual que, en caso de que la publicación no haya sido rechazada, los revisores soliciten cambios o explicaciones adicionales a los contenidos.
6. **PASO 6.** El autor revisa el trabajo tomando como base los comentarios de los revisores, reenviando al editor tanto el resultado del trabajo como la respuesta a los comentarios de los revisores.
7. **PASO 7.** Tras varias iteraciones sobre los pasos 5 y 6 el autor recibe la aceptación o rechazo definitivo.
8. **PASO 8.** El editor envía al autor la edición definitiva para su revisión antes de la publicación.
9. **PASO 9.** El trabajo es publicado.

Después de este proceso de revisión, si el artículo es aceptado es bastante probable que los revisores o los editores te soliciten algún cambio adicional y además deberéis firmar un ***copyright*** para que la revista pueda publicar el contenido con tu permiso.
...
Accede a la web ORCID en el siguiente enlace: <https://orcid.org/>
...
Las **revistas científicas** son la herramienta principal para difundir tu trabajo como investigador y suele ser el medio más valorado para mejorar tu **currículum profesional como investigador,** junto con los proyectos en los que has participado (que probablemente han generado también publicaciones).
...
El coste de la publicación suele ir incluido en el **coste de la inscripción de la conferencia** y normalmente, al igual que pasa con las revistas de *open access,* suele ser la propia institución y no el investigador el que paga la inscripción del congreso.
...
Se puede consultar en el siguiente enlace: <http://portal.core.edu.au/conf-ranks/>
...
Aparte de esta estructura, que cómo decimos puede ser adaptada a las necesidades del artículo en cuestión, hay una serie de **recomendaciones** que debemos tener en cuenta a la hora de realiza un texto científico.
...
<https://guiasbus.us.es/bibliografiaycitas/otrosestilos>

En el ámbito científico y técnico, estilos muy conocidos son los siguientes:
...
Los investigadores emplean **gestores bibliográficos** que les ayudan a catalogar y clasificar de forma eficiente la bibliografía empleada. Dos de los gestores bibliográficos más conocidos son **RefWorks** (<https://www.refworks.com/es/>) y **Mendeley** (<https://www.mendeley.com/>).
...
Figura 2. Crear una cuenta en Mendeley. Fuente: [www.mendeley.com](http://www.mendeley.com)
...
Figura 3. Acceso a Download. Fuente: [www.mendeley.com](http://www.mendeley.com)
...
Figura 7. Personalizando el estilo bibliográfico de las fuentes. Fuente: elaboración propia.
...
* **ResearchGate.** Plataforma gratuita que pone en contacto a millones de investigadores de todo el mundo y permite compartir conocimiento. Acceso a través de: <https://www.researchgate.net/>
* **Academia.edu.** Permite agrupar a los investigadores por intereses comunes, acceder a ofertas laborales, publicaciones. El usuario puede gestionar su propia página personal de forma ágil e intuitiva. Acceso a través de: <https://www.academia.edu/>

4.6. Referencias bibliográficas

Aguas, Á. C. (2015). *Cómo escribir escritura científica bien escrita*. Formación Alcalá.

Guy, N. (1999b). *Cómo escribir un artículo científico en inglés.*
...
<https://www.youtube.com/watch?v=krHpEWcvK3I>
...
<https://www.youtube.com/watch?v=PCdnhEC4Y2M>
...
1. En el ámbito científico el estado del arte hace referencia a:
...
1. A la hora de realizar un trabajo científico, siempre debemos comenzar buscando documentación previa sobre el tema que nos ocupa:
...
1. ¿Qué ventajas tienes el modelo *open-access*?
...
1. Los índices de impacto de una revista:
...
1. Los textos científicos deben ser:
...
1. La estructura de un artículo científico debe tener cómo mínimo:
...
1. ¿Dónde se pueden obtener citas para tu bibliografía?
...
1. ¿Qué es un gestor bibliográfico?
...
1. La red social más usada para divulgar la ciencia es:
