...
[Esquema 3](#_Toc153878618)

[Ideas clave 4](#_Toc153878619)

[2.1. Introducción y objetivos 4](#_Toc153878620)

[2.2. La ciencia y su método 4](#_Toc153878621)

[2.3. Metodologías de investigación en inteligencia artificial 8](#_Toc153878622)

[2.4. Metodología empírica cuantitativa 12](#_Toc153878623)

[2.5. Metodología empírica cualitativa 17](#_Toc153878624)

[2.6. Referencias bibliográficas 23](#_Toc153878625)

[A fondo 24](#_Toc153878626)

[Test 26](#_Toc153878627)
...
El acceso a la información necesaria para llevar a cabo esta tarea requiere de una **búsqueda exhaustiva** en diferentes fuentes de documentación y de conocimiento de otros expertos humanos que la comparten.
...
La **investigación cualitativa** se interesa **por captar la realidad a través de los ojos de los sujetos de estudio.** Es decir, a partir de la percepción que dicho sujeto tiene en su propio contexto. El investigador induce las propiedades del problema que se va a estudiar en base a la forma en la que los individuos se desenvuelven en el mundo donde se plantea el problema a resolver (Bonilla y Rodríguez, 1997).
...
Si en la fase de preparación había que tener en cuenta la formación y experiencia del investigador, en este momento del estudio resulta de una importancia crucial algunas características de este, que permitirán el avance de la investigación.
...
Los **procesos de recolección de datos** empleados en los estudios cualitativos normalmente no se basan en métodos estandarizados y es muy probable que el análisis no pueda ser estadístico o que este tenga poco peso, debido a que se centra en los puntos de vista de los diferentes individuos que forman parte del estudio. De hecho, para centrarse más en las experiencias de los sujetos, las muestras suelen ser pequeñas. Por lo tanto, usan principalmente el **método inductivo**, como explicamos al principio de tema.
...
* En antropología, este método permite analizar qué dice, cómo se comporta o cómo piensa un grupo étnico.
...
* Podemos evaluar un sistema recomendador en función de las opiniones de los usuarios.
...
Ramesh, V., Glass, R. L., y Vessey, I. (2004). *Research in computer science: an empirical study. Journal of systems and software,* 70(1-2), 165-176. Recuperado de <https://www.sciencedirect.com/science/article/abs/pii/S0164121203000153>
...
Paz-Enrique, L. E. (2023). Citas fantasmas en artículos científicos: problemática creciente ante el uso de la inteligencia artificial. *Revista Médica Electrónica*, *45*(6), 892-897. Recuperado de <http://scielo.sld.cu/scielo.php?script=sci_arttext&pid=S1684-18242023000600892&lng=es&tlng=pt>.
...
LastWeekTonight. (9 de mayo de 2016*). Scientific Studies: Last Week Tonight with John Oliver* [Vídeo]. Recuperado de: <https://www.youtube.com/watch?v=0Rnq1NpHdmw>
...
1. Es un elemento esencial de la ciencia:
...
1. El método científico tiene las siguientes fases:
...
1. La metodología cuantitativa es:
...
1. La metodología cualitativa tiene las siguientes partes:
...
1. Las conclusiones en la metodología cuantitativa:
...
1. Las principales técnicas que se utilizan en la investigación cualitativa son:

A. Entrevistas abiertas, observación no estructurada, revisión de documentos, discusiones en grupo, evaluación de experiencias.
...
1. Diseño de un experimento cuantitativo se debe:
...
1. La validación de los experimentos cualitativos:
